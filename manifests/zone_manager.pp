...
class designate::zone_manager (
  ...
  $zone_manager_package_name = $::params::zone_manager_package_name,
  $enabled                   = true,
  ...
  designate::generic_service { 'zone-manager':
    ...
    enabled        => $enabled,
    package_name   => pick($zone_manager_package_name, $::designate::params::zone_manager_package_name),
