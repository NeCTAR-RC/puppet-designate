...
#
# [*poll_retry_interval*]
#  (optional) The time between retrying to send a request and waiting for a
...
class designate::pool_manager (
  ...
  create_resources('pool_nameserver', $pool_nameserver_hash)
  create_resources('pool_target', $pool_target_hash)
}
